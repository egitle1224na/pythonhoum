# Задача 20: В настольной игре Скрабл (Scrabble) каждая буква имеет значение
# животных. В случае с английским алфавитом очки оцениваются так:
# ● А, Е, И, О, ​​У, Л, Н, С, Т, Р – 1 очко;
# ● Р, С – 2 очка;
# ● Б, В, М, П – 3 очка;
# ● F, H, V, W, Y – 4 очка;
# ● К – 5 очков;
...
# Считаем, что на вход подается только одно слово, которое содержит либо только
